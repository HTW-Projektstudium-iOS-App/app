...
extension Card {
  static var sampleUserCard: Card {
    Card(
      name: "Max Mustermann",
      ...
      contactInformation: ContactInformation(
        ...
        linkedInURL: "@maxmustermann",
      ),
      businessAddress: Address(street: "Hauptstraße 1", city: "Berlin", country: "Deutschland"),
      slogan: "Wir sind eine Firma.",
      style: CardStyle(
        primaryColor: Color(hexString: "#FF746C")!,
        secondaryColor: Color(hexString: "#7A3734")!,
  ...
  static var sampleCards: [Card] = [
    Card(
      ...
      style: CardStyle(
        ...
        fontName: "Copperplate", designStyle: .minimal
      ),
      collectionDate: Date(),
      collectionLocation: CLLocationCoordinate2D(latitude: 52.457821, longitude: 13.526853)
    ),
    Card(
      ...
      style: CardStyle(
        ...
        fontName: "Academy Engraved LET", designStyle: .traditional
      ),
      collectionDate: Date(),
    ...
    Card(
      ...
      style: CardStyle(
        ...
        fontName: "Papyrus", designStyle: .traditional
      ),
      collectionDate: Date(),
